ROOT_PATH="./SteeringAngle/SteeringAngle_64x64/CcGAN-improved"
...
echo "-------------------------------------------------------------------------------------------------"
echo "AE"
CUDA_VISIBLE_DEVICES=1,0 python3 pretrain_AE.py --root_path $ROOT_PATH --data_path $DATA_PATH --dim_bottleneck 512 --epochs 200 --resume_epoch 0 --batch_size_train 256 --batch_size_valid 64 --base_lr 0.01 --seed $SEED --min_label $MIN_LABEL --max_label $MAX_LABEL --CVMode
...
CUDA_VISIBLE_DEVICES=1,0 python3 pretrain_CNN_class.py --root_path $ROOT_PATH --data_path $DATA_PATH --CNN ResNet34_class --epochs 20 --batch_size_train 256 --batch_size_valid 64 --base_lr 0.01 --seed $SEED --valid_proport 0.2 --CVMode
