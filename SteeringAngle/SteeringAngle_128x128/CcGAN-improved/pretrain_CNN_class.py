...
# data loader
data_filename = args.data_path + '/SteeringAngle_5_scenes_' + str(args.img_size) + 'x' + str(args.img_size) + '.h5'
...
filename_ckpt = save_models_folder + '/ckpt_{}_epoch_{}_seed_{}_classify_{}_scenes_types_CVMode_{}.pth'.format(net_name, args.epochs, args.seed, num_classes, args.CVMode)
