...
def parse_opts():
    ...
    ''' Overall Settings '''
    parser.add_argument('--root_path', type=str, default='G:/OneDrive/Working_directory/CcGAN_TPAMI/SteeringAngle/SteeringAngle_128x128/CcGAN-improved')
    parser.add_argument('--data_path', type=str, default='G:/OneDrive/Working_directory/CcGAN_TPAMI/datasets/SteeringAngle')
    parser.add_argument('--eval_ckpt_path', type=str, default='G:/OneDrive/Working_directory/CcGAN_TPAMI/SteeringAngle/SteeringAngle_128x128/evaluation/eval_models')
