...
parser.add_argument('--root_path', type=str, default='/home/xin/OneDrive/Working_directory/CcGAN/RC-49')
...
if args.CVMode:
    ...
    indx_valid = indx_all[0:int(valid_prop*len(labels))]
    indx_train = indx_all[int(valid_prop*len(labels)):]
