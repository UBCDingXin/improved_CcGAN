...
parser = argparse.ArgumentParser(description='separate real angles according to angles.')
...
output_dir_base = os.path.join(args.out_dir_base, 'real_images_by_angles')
