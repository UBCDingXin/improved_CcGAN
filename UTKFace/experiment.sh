...
## tensorboard --logdir /home/xin/OneDrive/Working_directory/Continuous_cGAN/UTKFace/Output/saved_logs

SEED=2020
MAX_N_IMG_PER_LABEL=10000
EPOCH_GAN=800
EPOCH_CNN=200
BATCH_SIZE=512
SIGMA=-1.0
...
# echo "-------------------------------------------------------------------------------------------------"
# echo "Continuous cDCGAN"
# CUDA_VISIBLE_DEVICES=1,0 python3 main.py --GAN ContcDCGAN --seed $SEED --img_size $IMG_SIZE --max_num_img_per_label $MAX_N_IMG_PER_LABEL --threshold_type soft --kernel_sigma -1.0 --kappa 3600.0 --epoch_gan $EPOCH_GAN --lr_g_gan $LR_G --lr_d_gan $LR_D --batch_size_gan $BATCH_SIZE --nfake $NFAKE --visualize_fake_images #--comp_LS --comp_FID --epoch_FID_CNN $EPOCH_CNN
