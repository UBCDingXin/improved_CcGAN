...
def SampcDCGAN(netG, class2label, GAN_Latent_Length = 128, NFAKE = 10000, batch_size = 500, nc=3, img_size=64, num_classes = 100, device="cuda"):
    '''
...
def SampcDCGAN_given_label(netG, given_label, unique_labels, label2class, nc=3, img_size=64, GAN_Latent_Length = 128, NFAKE = 10000, batch_size = 500, device="cuda"):
    '''
