...
def train_GAN(EPOCHS_GAN, GAN_Latent_Length, trainloader, netG, netD, optimizerG, optimizerD, criterion, save_models_folder = None, ResumeEpoch = 0, device="cuda", plot_in_train=False, save_images_folder = None, samples_tar = None, num_features = 2):
