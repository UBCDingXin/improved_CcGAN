...
def parse_opts():
    ...
    parser.add_argument('--batch_size_embed', type=int, default=256)
    ...
    parser.add_argument('--nfake_per_label', type=int, default=100)
    ...
    parser.add_argument('--FID_num_centers', type=int, default=100)
