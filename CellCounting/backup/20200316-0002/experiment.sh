...
echo "########################################################################################"
# CUDA_VISIBLE_DEVICES=0 python3 pretrain_CNN_regre.py --start_count $START_COUNT --end_count $END_COUNT --CNN ResNet34_regre --epochs 200 --batch_size_train 256 --batch_size_valid 64 --base_lr 0.01 --seed $SEED --transform --CVMode
CUDA_VISIBLE_DEVICES=0 python3 pretrain_CNN_regre.py --start_count $START_COUNT --end_count $END_COUNT --CNN ResNet34_regre --epochs 200 --batch_size_train 256 --batch_size_valid 64 --base_lr 0.01 --seed $SEED --transform

# CUDA_VISIBLE_DEVICES=0 python3 pretrain_CNN_class.py --start_count $START_COUNT --end_count $END_COUNT --CNN ResNet34_class --epochs 200 --batch_size_train 256 --batch_size_valid 64 --base_lr 0.01 --seed $SEED --transform --CVMode
CUDA_VISIBLE_DEVICES=0 python3 pretrain_CNN_class.py --start_count $START_COUNT --end_count $END_COUNT --CNN ResNet34_class --epochs 200 --batch_size_train 256 --batch_size_valid 64 --base_lr 0.01 --seed $SEED --transform
