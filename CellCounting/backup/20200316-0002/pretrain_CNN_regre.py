...
def net_initialization(Pretrained_CNN_Name, ngpu = 1):
    if Pretrained_CNN_Name == "ResNet18_regre":
        net = ResNet18_regre(ngpu = ngpu, is_label_positive=True)
    elif Pretrained_CNN_Name == "ResNet34_regre":
        net = ResNet34_regre(ngpu = ngpu, is_label_positive=True)
    elif Pretrained_CNN_Name == "ResNet50_regre":
        net = ResNet50_regre(ngpu = ngpu, is_label_positive=True)
    elif Pretrained_CNN_Name == "ResNet101_regre":
        net = ResNet101_regre(ngpu = ngpu, is_label_positive=True)
