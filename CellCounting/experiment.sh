...
echo "########################################################################################"
echo "                Run script with ONE GPU Except GAN and cGAN !!!!                        "
echo "########################################################################################"
...
# echo "-------------------------------------------------------------------------------------------------"
# echo "cDCGAN"
# CUDA_VISIBLE_DEVICES=1 python3 main.py --GAN cDCGAN --transform --epoch_gan 500 --lr_g_gan 2e-4 --lr_d_gan 1e-4 --batch_size_gan 256 --resumeTrain_gan 0 --seed $SEED
...
CUDA_VISIBLE_DEVICES=0 python3 main.py --start_count 4 --end_count 300 --stepsize_count 2 --num_imgs_per_count 6 --GAN Continuous_cDCGAN --normalize_count --transform --kernel_sigma 0.006 --threshold_type hard --kappa 0.012 --dim_gan 128 --epoch_gan 500 --lr_g_gan 2e-4 --lr_d_gan 1e-4 --batch_size_gan 128 --resumeTrain_gan 0 --seed $SEED
