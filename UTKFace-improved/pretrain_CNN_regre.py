...
parser.add_argument('--root_path', type=str, default='/home/xin/OneDrive/Working_directory/CcGAN/UTKFace-improved')
parser.add_argument('--data_path', type=str, default='/home/xin/OneDrive/Working_directory/CcGAN/dataset/UTKFace')
